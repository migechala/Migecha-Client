...
import migecha.ServerDataFeatured;
...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        if(isFeaturedServer) {
        	drawImg(x, y, false, ServerDataFeatured.STAR);
        }
    ...
    private void drawImg(int x, int y, boolean bottom, ResourceLocation texture) {
    	this.mc.getTextureManager().bindTexture(texture);
    	Gui.drawModalRectWithCustomSizedTexture(x-16, bottom ? y+16 : y, 0.0F, 0.0F, 16, 16, 16, 16);
    }
