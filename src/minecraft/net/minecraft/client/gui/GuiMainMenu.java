...
import migecha.minecraftLogin.AutoLogin;
import migecha.minecraftLogin.GuiLogin;
import migecha.minecraftLogin.LoginThread;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public GuiMainMenu()
    {
        ...
        login = new AutoLogin(this.loginCredentials);
        login.tryLogin();
        try
        {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, j + 68 + 10 * 3, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, j + 68 + 10 * 3, 98, 20, I18n.format("menu.quit", new Object[0])));
        this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124, j + 68 + 10 * 3));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(login.isLoggedIn()) {
    		buttonList.add(new GuiButton(15, this.width / 2 - 100, this.height / 4 + 48 + 24 * 3 , "Already Logged in."));
        }
        else {
        	buttonList.add(new GuiButton(15, this.width / 2 - 100, this.height / 4 + 48 + 24 * 3 , "Login To Play Multiplayer"));
        }
